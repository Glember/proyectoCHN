...
const SolicitarPrestamo = () => {
    ...
    const listaClienteAll = async () => {
        const respuesta = await getFetchGET("http://localhost:8080/api/cliente/getClienteAll", "");
    ...
    const listaSolicitudPrestamoTable = async () => {
        ...
        const respuesta = await getFetchGET("http://localhost:8080/api/solicitudPrestamo/getSolicitudesPrestamoAllTable", "");
        console.log("respuesta", respuesta.data);
    ...
    const guardarSolicitudPrestamo = async () => {
        ...
        if(idSolicitudPrestamo !== "") {
            datosSolitudPrestamo = {
                ...
                "estadoPrestamo": opcionSeleccionadaEstado
            };
        } else {
            datosSolitudPrestamo = {
                "idCliente": opcionSeleccionadaCliente,
        ...
        const respuesta = await postFetchAll("http://localhost:8080/api/solicitudPrestamo/saveOrUpdateSolicitudPrestamo", "POST", datosSolitudPrestamo);
    ...
    const editarSolicitudPrestamo = async (item) => {
        ...
        setOpcionSeleccionadaEstado(item.estadoPrestamo);
