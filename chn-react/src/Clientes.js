...
const Clientes = () => {
  ...
  const guardarCliente = async () => {
    ...
    const respuesta = await postFetchAll("http://localhost:8080/api/cliente/guardarCliente", "POST", datosCliente);
  ...
  const eliminarCliente = async (idCliente) => {
    ...
    const respuesta = await postFetchAll("http://localhost:8080/api/cliente/eliminarCliente/" + idCliente, "DELETE", {});
    console.log("respuesta", respuesta);
